...
const generateAssistantData = (): AssistantSatisfactionData[] => {
  ...
  _mockAIAssistants.forEach((assistant) => {
    ...
    // Pour les assistants de type "japprends", ajouter des entrées supplémentaires
    if (assistant.type === 'japprends' && assistant.subject) {
...
export const mockRecentFeedbacks: FeedbackComment[] = [
  { id: 'fb1', date: '2025-03-28', assistant: 'japprends', rating: 5, comment: 'Explication très claire des règles de division!', tags: ['clair', 'utile'], educationLevel: 'CM1', subject: 'Mathématiques', chapter: 'Multiplications et Divisions', exercise: 'exercice-division-1' },
  { id: 'fb2', date: '2025-03-27', assistant: 'japprends', rating: 3, comment: 'Explication un peu compliquée pour mon niveau.', tags: ['difficile', 'confus'], educationLevel: 'CE1', subject: 'Français', chapter: 'Grammaire de Base', exercise: 'exercice-grammaire-1' },
  ...
  { id: 'fb4', date: '2025-03-26', assistant: 'japprends', rating: 5, comment: 'Parfait pour comprendre la notion de périmètre!', tags: ['parfait', 'clair'], educationLevel: 'CM2', subject: 'Mathématiques', chapter: 'Géométrie de Base', exercise: 'exercice-mesures-1' },
  ...
  { id: 'fb6', date: '2025-03-25', assistant: 'japprends', rating: 4, comment: 'Explications claires, mais pourrait être plus interactif.', tags: ['clair', 'améliorable'], educationLevel: 'CP', subject: 'Mathématiques', chapter: 'Additions et Soustractions', exercise: 'exercice-addition-1' },
  ...
  { id: 'fb8', date: '2025-03-23', assistant: 'japprends', rating: 4, comment: 'Bonne explication des conjugaisons.', tags: ['utile', 'éducatif'], educationLevel: 'CE2', subject: 'Français', chapter: 'Grammaire de Base', exercise: 'exercice-conjugaison-1' },
  { id: 'fb9', date: '2025-03-22', assistant: 'japprends', rating: 1, comment: 'Je n\'ai pas du tout compris l\'explication des fractions.', tags: ['confus', 'difficile'], educationLevel: 'CM1', subject: 'Mathématiques', chapter: 'Problèmes Simples', exercise: 'exercice-probleme-2' },
  { id: 'fb10', date: '2025-03-21', assistant: 'japprends', rating: 3, comment: 'Moyen, il manque des exemples concrets.', tags: ['moyen', 'incomplet'], educationLevel: 'CE2', subject: 'Histoire', chapter: 'Moyen Âge', exercise: 'exercice-moyen-age-1' },
  ...
  { id: 'fb12', date: '2025-03-19', assistant: 'japprends', rating: 4, comment: 'Bon exercice de vocabulaire, mais un peu court.', tags: ['bon', 'court'], educationLevel: 'CE1', subject: 'Français', chapter: 'Vocabulaire', exercise: 'exercice-vocabulaire-1' },
  { id: 'fb13', date: '2025-03-18', assistant: 'japprends', rating: 5, comment: 'Excellente aide pour apprendre les couleurs en anglais!', tags: ['excellent', 'interactif'], educationLevel: 'CP', subject: 'Anglais', chapter: 'Nombres et Couleurs', exercise: 'exercice-couleurs-1' },
  ...
  { id: 'fb15', date: '2025-03-16', assistant: 'japprends', rating: 2, comment: 'Pas assez d\'explications sur l\'Europe.', tags: ['insuffisant', 'incomplet'], educationLevel: 'CM2', subject: 'Géographie', chapter: 'LEurope', exercise: 'exercice-europe-1' },
  { id: 'fb16', date: '2025-03-15', assistant: 'japprends', rating: 5, comment: 'Explication parfaite de la préhistoire!', tags: ['parfait', 'intéressant'], educationLevel: 'CE2', subject: 'Histoire', chapter: 'Préhistoire et Antiquité', exercise: 'exercice-prehistoire-1' },
  { id: 'fb17', date: '2025-03-14', assistant: 'japprends', rating: 4, comment: 'Bon exercice sur les formes géométriques.', tags: ['utile', 'visuel'], educationLevel: 'CP', subject: 'Mathématiques', chapter: 'Géométrie de Base', exercise: 'exercice-formes-1' },
  ...
  { id: 'fb19', date: '2025-03-12', assistant: 'japprends', rating: 5, comment: 'Excellent pour apprendre les nombres en anglais!', tags: ['excellent', 'pratique'], educationLevel: 'CE1', subject: 'Anglais', chapter: 'Nombres et Couleurs', exercise: 'exercice-nombres-1' },
  { id: 'fb20', date: '2025-03-11', assistant: 'japprends', rating: 1, comment: 'Explication trop compliquée pour la Renaissance.', tags: ['compliqué', 'confus'], educationLevel: 'CM1', subject: 'Histoire', chapter: 'Renaissance', exercise: 'exercice-renaissance-1' },
  { id: 'fb21', date: '2025-03-10', assistant: 'japprends', rating: 4, comment: 'Bonne aide pour la lecture!', tags: ['utile', 'progressif'], educationLevel: 'CP', subject: 'Français', chapter: 'Lecture et Compréhension', exercise: 'exercice-lecture-1' },
  ...
  { id: 'fb23', date: '2025-03-08', assistant: 'japprends', rating: 3, comment: 'Exercice sur la France moyennement intéressant.', tags: ['moyen', 'basique'], educationLevel: 'CM2', subject: 'Géographie', chapter: 'La France', exercise: 'exercice-france-1' },
  { id: 'fb24', date: '2025-03-07', assistant: 'japprends', rating: 5, comment: 'Super pour apprendre les premiers mots en anglais!', tags: ['super', 'ludique'], educationLevel: 'CP', subject: 'Anglais', chapter: 'Salutations et Présentations', exercise: 'exercice-salutations-1' },
  { id: 'fb25', date: '2025-03-06', assistant: 'japprends', rating: 4, comment: 'Bonnes explications, mais pourrait être plus concises.', tags: ['utile', 'concis'], educationLevel: 'CM1', subject: 'Mathématiques', chapter: 'Problèmes Simples', exercise: 'exercice-probleme-1' }
];
