...
<FontAwesomeIcon
  icon={
    (task.priority === 'low' && faArrowDown) ||
    (task.priority === 'medium' && faArrowRight) ||
    faArrowUp
  }
  style={{
    top: 4,
...
/>
    ...
    const renderInfo = (
      <Stack direction="row" alignItems="center">
        ...
        >
          <FontAwesomeIcon icon={faComments} style={{ marginRight: '0.25rem', width: 16 }} />

          <Box component="span" sx={{ mr: 1 }}>
            {task?.comments?.length}
          </Box>

          <FontAwesomeIcon icon={faPaperclip} style={{ marginRight: '0.25rem', width: 16 }} />
