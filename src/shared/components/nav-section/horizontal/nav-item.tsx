...
import { faInfoCircle, faChevronDown, faChevronRight } from '@fortawesome/free-solid-svg-icons';
      ...
      >
        ...
        {caption && (
          <Tooltip title={caption} arrow>
            <FontAwesome icon={faInfoCircle} className={navSectionClasses.item.caption} />
          </Tooltip>
        )}
